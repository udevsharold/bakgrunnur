#import "../common.h"
#include "BakgrunnurAppNetworkController.h"
...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        if ([self runCommand:@"which netstat"] != 0){
            ...
            [errorGroupSpec setProperty:@"Oh no, your jailbreak doesn't have support package for this feature to work. Try to install \"Network Commands\" (network-cmds) from package manager." forKey:@"footerText"];
